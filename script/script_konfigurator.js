...
jelenet.fog=new THREE.Fog(hatterszin,20,110); 
...
mozgatas.maxDistance=(window.innerWidth/window.innerHeight)+60; // alapérték: 60
...
function onColorChange(){
    ...
    //cipő eltárolása sütiben
    var szovegesitesAnyagok=JSON.stringify(anyagokTomb);
    var szovegesitesSzinek=JSON.stringify(szinekTomb);
    document.cookie="anyagokkonf="+szovegesitesAnyagok;
    document.cookie="szinekkonf="+szovegesitesSzinek;
...
//elkeszült cipő menüje

function cipoMenu()
{
    if(document.getElementById("cipoMenuNyitas").style.height=="250px")
        menuZar();
    else
        {
            document.getElementById("cipoMenuNyitas").style.height="250px";
        }

}
function menuZar()
{
    document.getElementById("cipoMenuNyitas").style.height="0px";
}
function elment()
{
    document.getElementById("szemetes").style.display="none";
    document.getElementById("bemutatoterem").style.display="none";
    document.getElementById("mentes").style.textAlign="center";
    document.getElementById("cipoElnevezes").style.display="block";
}
function mentesVissza()
{
    document.getElementById("szemetes").style.display="inline-block";
    document.getElementById("bemutatoterem").style.display="inline-block";
    document.getElementById("cipoElnevezes").style.display="none";
}
function torolCipo()
{
    document.cookie = "anyagokkonf=; expires=Thu, 01 Jan 1970 00:00:00 UTC";
    document.cookie = "szinekkonf=; expires=Thu, 01 Jan 1970 00:00:00 UTC";
    window.location.replace("konfigurator.php");
}
...
var anyagvan=egySuti("anyagokkonf");
var szinvan=egySuti("szinekkonf");
